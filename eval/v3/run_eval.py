...
Usage:
    python -m eval.v3.run_eval --run-id "v3-first"
    python -m eval.v3.run_eval --run-id "v3-first" --compare-with "v4-topk15-prompts"
    python -m eval.v3.run_eval --no-router --run-id "v3-ablation-no-router"
    python -m eval.v3.run_eval --no-map-reduce --run-id "v3-ablation-no-mr"
    python -m eval.v3.run_eval --force-strategy standard --run-id "v3-standard-only"
"""
...
from eval.v3.config import V3EvalConfig
from eval.v3.instrumentation.rag_wrapper_v3 import create_v3_rag
