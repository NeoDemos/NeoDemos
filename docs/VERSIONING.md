...
- [ ] **WS6 Source-spans-only summarization** — `services/summarizer.py` ✅ + verifier ✅ + Gemini Batch pipeline ✅ + bulk backfill ✅ *(28,223 verified + 853 partial, 2026-04-16)*; MCP tool `vat_document_samen` + UI verification badges + strip test still pending
