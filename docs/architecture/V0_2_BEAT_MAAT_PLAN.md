...
> | WS4 Best-in-class MCP | [`docs/handoffs/done/WS4_MCP_DISCIPLINE.md`](../handoffs/done/WS4_MCP_DISCIPLINE.md) | not started |
...
- [ ] **Quality audit:** SQL counts + deterministic spot-checks + LLM-judge sample of 200 entities, plus a regression check that the [FEEDBACK_LOG.md 2026-04-11](../../.coordination/FEEDBACK_LOG.md) Heemraadssingel query now returns chunks (was 0 hits)
