...
### Tool API improvements (~1 day) *(added 2026-04-11, triaged from [FEEDBACK_LOG.md 2026-04-11](../../.coordination/FEEDBACK_LOG.md))*
...
### Retrieval quality fixes (~0.5 day) *(added 2026-04-11, triaged from [FEEDBACK_LOG.md 2026-04-11 "Haven & Duurzaamheid"](../../.coordination/FEEDBACK_LOG.md))*
...
**Why:** Two full test sessions against the live MCP surface (onderwijs / sociale huur + nachtleven / stemgedrag) produced a structured bug list. Raw feedback in [`.coordination/FEEDBACK_LOG.md` 2026-04-14](../../.coordination/FEEDBACK_LOG.md). These items are distinct from the 8 pre-alpha.2 blockers — all of those shipped. These are next-pass quality fixes on shipped tools. Target release: **v0.2.0 cleanup pass before eval gate** (except where noted).
